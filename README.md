...
Documentation is generated by [Doxygen](doxy). It is not saved to version
control, but a configuration template is.

[doxy]: http://www.stack.nl/~dimitri/doxygen/

To generate and view documentation do the following:

1. Install Doxygen 1.8.6.
2. Run `doxygen crystal-c-levitation.doxy` in project root.
3. Browse to `doc/html/index.html`
